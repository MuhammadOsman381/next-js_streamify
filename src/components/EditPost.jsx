...
const EditPost = (props) => {
  ...
  const [description, setDescription] = useState(props.postData.description);
  const [video, setVideo] = useState(props.postData.video);
  const [thumbnail, setThumbnail] = useState(props.postData.thumbnail);
  const [videoPreview, setVideoPreview] = useState(props.postData.video);
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .put(
        `/api/post/edit/${props.postData._id}`,
        formData,
